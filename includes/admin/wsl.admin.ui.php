...
<div class="wsl-container">
	...
	<div class="alignright">
		...
		<a style="font-size: 0.9em; text-decoration: none;" target="_blank" href="<?php echo $githubhomeurl ?>/wordpress-social-login"><?php _wsl_e('Modified by', 'wordpress-social-login') ?>  Nalandabodhi</a>
	</div>
